...
_global_options = [
click.option('--env', type=str, default='RockerMujocoEnv-sparse-gripper_random-o3-h1-3-v1', help='the name of the OpenAI Gym environment that you want to train on'),
