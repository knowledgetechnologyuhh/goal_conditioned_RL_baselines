...
_global_options = [
click.option('--env', type=str, default='TowerBuildMujocoEnv-sparse-gripper_above-o1-h1-1-v1', help='the name of the OpenAI Gym environment that you want to train on'),
...
click.option('--early_stop_success_rate', type=int, default=100, help='The required mean success rate  over the last 4 epochs in % to trigger early stopping. 0 for no early stopping'),
