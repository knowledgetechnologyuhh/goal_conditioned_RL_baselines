...
The following instructions are **optimized for Ubuntu version 18.04** or earlier (Python 3.7). Python 3.8 (default for Ubuntu 20) will not work because it does not support Tensorflow < 2.0. 

Known issue: gripper_random is currently not supported / hangs.
