...
click.option('--rep_network_class', type=str, default='baselines.her_pddl.obs2preds:Obs2PredsDenseModel', help='The Neural network model to use for learning representations.'),
