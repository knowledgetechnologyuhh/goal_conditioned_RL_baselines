...
class Layer(Policy):
    ...
    def __init__(self, input_dims, buffer_size, hidden, layers, network_class, polyak, batch_size,
                 ...
                 sample_transitions, gamma,
                 sess, layer_id, reuse=False,**kwargs):
        ...
        self.scope = scope + '_layer_{}'.format(layer_id)
        ...
        with tf.variable_scope(self.scope):
            ...
            print(self.stage_shapes.values())
    ...
    def _create_network(self, reuse=False):
        logger.info("Creating DDPG for Layer %s with action space %d x %s..." % (self.layer_id, self.dimu, self.max_u))
